...
const authenticatedUser = (username,password)=>{ //returns boolean
    //Task6 - Based on Practice project - write code to check if username and password match the one we have in records.
...
regd_users.delete("/auth/review/:isbn", (req, res) => {
    ...
    if (typeof books[isbn] != undefined) 
    {
        if(typeof books[isbn].reviews[username] != undefined)
        {
